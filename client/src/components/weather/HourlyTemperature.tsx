...
//     // FIX 1: Prevent infinite loops in useEffect
//     useEffect(() => {
...
//         setActiveIndex((prev) => (index !== -1 && prev !== index ? index : prev));
//     }, [data]);
...
//                         <AreaChart
//                             data={data}
//                             // FIX 2: Check current index to prevent redundant updates while hovering
//                             onMouseMove={(e) => {
