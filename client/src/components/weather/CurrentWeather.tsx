...
// // This ensures the card color matches the "Vibe" of the weather
...
//             : "from-blue-500 via-blue-400 to-indigo-400"; // Keep it dark enough for white text
//     }
...
//                 {/* Decorative Pattern Background (Subtle Circles) */}
...
// function DetailCard({ icon, title, value, subValue }: { icon: React.ReactNode, title: string, value: string, subValue: string }) {
//     return (
//         <Card className="border-none shadow-sm bg-white/80 backdrop-blur-sm hover:bg-white hover:shadow-md transition-all duration-300 group">
//             <CardContent className="p-4 flex flex-col gap-3">
//                 <div className="flex items-center gap-2 text-slate-500 text-sm font-medium group-hover:text-blue-600 transition-colors">
//                     {icon}
//                     {title}
//                 </div>
//                 <div>
